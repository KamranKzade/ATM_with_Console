        ...
        foreach (var client in clients)
        {
            if (client.BankCard == clientw.BankCard)
            {
                if (client.BankCard.Balans >= x)
                {
                    ...
                    throw new ArgumentOutOfRangeException("Balansda bu qeder pul yoxdur");
            }
            else
                throw new NotImplementedException("Bele Kart yoxdur");
        }
        throw new Exception("Emeliyyat alinmadi");
    }
